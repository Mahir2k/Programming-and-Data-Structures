...
public class Test{
    ...
    public static void testList(List<Integer> list){
        System.out.println("\nTest case 1: add methods: add(E), add(int,E), addFirst(E), addLast(E)");
        list.add(11);
        list.add(22);
        list.add(1, 33);
        list.addFirst(44);
        ...
        System.out.println("\nTest case 2: clone method");
        List<Integer> copylist = clone(list);
        System.out.println(list + ".clone() = " + copylist);

        System.out.println("\nTest case 3: Collection methods: addAll, containsAll, retainAll, removeAll");
        ...
        copylist = clone(list);
        System.out.println(list + ".containsAll(" + copylist + ") = " + list.containsAll(copylist));
        list.removeFirst();
        System.out.println(list + ".containsAll(" + copylist + ") = " + list.containsAll(copylist));

        System.out.println("\nTest case 4: getters: get(int), getFirst(), getLast()");
        ...
        System.out.println("\nTest case 6: remove methods: remove(Object), remove(int), removeFirst(), removeLast()");
        Integer i = 55;
        System.out.println(copylist);
        ...
        System.out.println("\nTest case 7: search methods: contains(Object), indexOf(Object), lastIndexOf(Object)");
        ...
        System.out.println("\nTest case 8: iterator methods: iterator, listIterator, listIterator(int)");
        ...
        System.out.println("\nTest case 12: reversed method");
        System.out.println("list before reverse(): " + nlist);
        List<Integer> rlist = nlist.reversed();
        System.out.println("list after reverse(): " + rlist);

        System.out.println("\nTest case 13: subList method");
        System.out.println("list: " + nlist);
        List<Integer> slist = nlist.subList(0, nlist.size());
        System.out.println("sublist from 0 to " + nlist.size() + ": " + slist);
        slist = nlist.subList(1, nlist.size()/2);
        System.out.println("sublist from 1 to " + (nlist.size()/2) + ": " + slist);
        slist = nlist.subList(5, 2);
        System.out.println("sublist from 5 to 2: " + slist);
        slist = nlist.subList(3, 3);
        System.out.println("sublist from 3 to 3: " + slist);
    }
