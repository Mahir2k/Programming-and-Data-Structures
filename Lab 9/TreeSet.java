...
public class TreeSet<E>{
    ...
    public static int removeIterations, addIterations, containsIterations;
    ...
    /**
     * Find the the maximum of the heights of the left subtree and right subtree plus one
    ...
    /**
     * Recursively check if for each node, the heights of the left subtree and the right subtree differ by 1 at most
